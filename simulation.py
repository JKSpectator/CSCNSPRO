...
from communication_simulation import Communication
...
class Simulation():
    ...
    def setupAnimation(
        ...
        self.makeEarthActorsUseJPG(EARTH_RADIUS)
    ...
    def makeEarthActorsVtkSource(self, earth_radius):
        """
    ...
    def makeEarthActorsUseJPG(self, earth_radius):
        """
		generate the earth sphere, and the landmass outline
        ...
        # Create an actor
        self.sphereActor = vtk.vtkActor()
        self.sphereActor.SetMapper(self.earthMapper)

        # # set color
        self.sphereActor.GetProperty().SetColor(LANDMASS_OUTLINE_COLOR)
        self.sphereActor.GetProperty().SetOpacity(EARTH_LAND_OPACITY)
